...
for train_index,test_index in kf.split(all_x):
    ...
    i+=1
    np.savez(f'../../data/new/npz/train/ESM_650M_train_fold{i}.npz',x=train_x,y=train_y,allow_pickle=True)
    np.savez(f'../../data/new/npz/test/ESM_650M_test_fold{i}.npz',x=test_x,y=test_y,allow_pickle=True)
    break
