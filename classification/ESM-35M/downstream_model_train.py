...
model.to(device)
train_data_path = f'../../data/new/npz/train/ESM_35M_train_fold1.npz'
test_data_path = f'../../data/new/npz/test/ESM_35M_test_fold1.npz'
