...
model.to(device)
train_data_path = f'../../data/new/npz/train/ESM_150M_train_fold1.npz'
test_data_path = f'../../data/new/npz/test/ESM_150M_test_fold1.npz'
...
for epoch in range(num_epoches):
    ...
    with torch.no_grad():
        ...
        t2=time.time()
        print(f'test epoch {epoch + 1},loss:{running_loss / len(test_set)},acc:{acc/len(test_set)*100},time:{t2-t1},perplexity:{perplexity/len(test_set)}\n')
