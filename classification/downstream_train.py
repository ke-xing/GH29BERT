...
model.to(device)
train_data_path = f"../data/new/npz/train/train_95_500_fold1.npz"
test_data_path = f"../data/new/npz/test/test_95_500_fold1.npz"
...
model.to("cpu")
torch.save(model, f"down_model_500_kfold1.pt")
